...
<div class="div">
    <!-- 导航1-->
    <div class="div1">
        <span class="span1_1">您当前位置：<a href="#">合肥二手房</a> > 出售房源</span>
    </div>
    <!-- 导航2-->
    <div class="div2">
        <div class="div2_1">
            <span class="span2_1_1"><a href="#">地域地标</a></span><span class="span2_1_2">
            <a href="/Home/Sale/Sale_LookHou">小区找房</a></span>
            <span class="span2_1_3"><a href="/Home/Sale/addData">我要卖房</a></span>
        </div>
        <div class="div2_2">
            <div class="div2_2_1">
            <span class="span2_2_1">区域</span>
                <span class="span2_2_2">
                <a href="/Home/Sale/Sale_Shouye/<?php echo arr2link($qArr,'fn');?>">不限</a>
                </span>

             <span class="span2_2_3">
                <a href="/Home/Sale/Sale_Shouye/<?php echo arr2link($qArr,'fn');?>fn/ss">蜀山区</a>
                <a href="/Home/Sale/Sale_Shouye/<?php echo arr2link($qArr,'fn');?>fn/ly">庐阳区</a>
                <a href="/Home/Sale/Sale_Shouye/<?php echo arr2link($qArr,'fn');?>fn/bhe">包河区</a>
                <a href="/Home/Sale/Sale_Shouye/<?php echo arr2link($qArr,'fn');?>fn/yh">瑶海区</a>
                <a href="/Home/Sale/Sale_Shouye/<?php echo arr2link($qArr,'fn');?>fn/zw">政务区</a>
                <a href="/Home/Sale/Sale_Shouye/<?php echo arr2link($qArr,'fn');?>fn/bhu">滨湖区</a>
                <a href="/Home/Sale/Sale_Shouye/<?php echo arr2link($qArr,'fn');?>fn/jk">经开区</a>
                <a href="/Home/Sale/Sale_Shouye/<?php echo arr2link($qArr,'fn');?>fn/xz">新站区</a>
                <a href="/Home/Sale/Sale_Shouye/<?php echo arr2link($qArr,'fn');?>fn/bc">北城新区</a>
                <a href="/Home/Sale/Sale_Shouye/<?php echo arr2link($qArr,'fn');?>fn/fd">肥东</a>
                <a href="/Home/Sale/Sale_Shouye/<?php echo arr2link($qArr,'fn');?>fn/fx">肥西</a>
                <a href="/Home/Sale/Sale_Shouye/<?php echo arr2link($qArr,'fn');?>fn/cf">长丰</a>
                <a href="/Home/Sale/Sale_Shouye/<?php echo arr2link($qArr,'fn');?>fn/ch">巢湖</a>
                <a href="/Home/Sale/Sale_Shouye/<?php echo arr2link($qArr,'fn');?>fn/lj">庐江</a>
            </span>
            </div>
             <script type="text/javascript">
                 $(function(){
            ...
            <div class="div2_2_1">
                <span class="span2_2_1">售价</span>
                <span class="span2_2_2">
                <a href="/Home/Sale/Sale_Shouye/<?php echo arr2link($qArr,'sell');?>">不限</a>
                </span>

                <span class="span2_2_3" id="sell">
                    <a href="/Home/Sale/Sale_Shouye/<?php echo arr2link($qArr,'sell');?>sell/1">40万以下</a>
                    <a href="/Home/Sale/Sale_Shouye/<?php echo arr2link($qArr,'sell');?>sell/2">40-70万</a>
                    <a href="/Home/Sale/Sale_Shouye/<?php echo arr2link($qArr,'sell');?>sell/3">70-80万</a>
                    <a href="/Home/Sale/Sale_Shouye/<?php echo arr2link($qArr,'sell');?>sell/4">80-90万</a>
                    <a href="/Home/Sale/Sale_Shouye/<?php echo arr2link($qArr,'sell');?>sell/5">90-100万</a>
                    <a href="/Home/Sale/Sale_Shouye/<?php echo arr2link($qArr,'sell');?>sell/6">100万以上</a>
                </span>
             </div>
            ...
            <div class="div2_2_1">
                ...
                <span class="span2_2_2">
                <a href="/Home/Sale/Sale_Shouye/<?php echo arr2link($qArr,'house');?>">不限</a>
                </span>
                <span class="span2_2_3" id="house">
                <a href="/Home/Sale/Sale_Shouye/<?php echo arr2link($qArr,'house');?>house/1">一室</a>
                <a href="/Home/Sale/Sale_Shouye/<?php echo arr2link($qArr,'house');?>house/2">二室</a>
                <a href="/Home/Sale/Sale_Shouye/<?php echo arr2link($qArr,'house');?>house/3">三室</a>
                <a href="/Home/Sale/Sale_Shouye/<?php echo arr2link($qArr,'house');?>house/4">四室</a>
                <a href="/Home/Sale/Sale_Shouye/<?php echo arr2link($qArr,'house');?>house/5">五室</a>
                <a href="/Home/Sale/Sale_Shouye/<?php echo arr2link($qArr,'house');?>house/6">五室以上</a>
                </span>
            </div>


            <div class="div2_2_1">
                <span class="span2_2_1">面积</span> <span class="span2_2_2">
                <a href="/Home/Sale/Sale_Shouye/<?php echo arr2link($qArr,'area');?>">不限</a>
               </span>
                <span class="span2_2_3" id="area">
                    <a href="/Home/Sale/Sale_Shouye/<?php echo arr2link($qArr,'area');?>area/1">50㎡以下</a>
                    <a href="/Home/Sale/Sale_Shouye/<?php echo arr2link($qArr,'area');?>area/2">50-70㎡</a>
                    <a href="/Home/Sale/Sale_Shouye/<?php echo arr2link($qArr,'area');?>area/3">70-90㎡</a>
                    <a href="/Home/Sale/Sale_Shouye/<?php echo arr2link($qArr,'area');?>area/4">90-110㎡</a>
                    <a href="/Home/Sale/Sale_Shouye/<?php echo arr2link($qArr,'area');?>area/5">110-150㎡</a>
                    <a href="/Home/Sale/Sale_Shouye/<?php echo arr2link($qArr,'area');?>area/6">150㎡以上</a>
                </span>
            </div>
        </div>
    </div>
    ...
    <div class="div3">
        <div>
            <div class="div3_1">
                <span class="span3_1_1"><a href="#">出售房源</a></span><span class="span3_1_3"><a href="/Home/Sale/Sale_PerHou">个人房源</a></span>
            </div>
            <div style="clear:both" class="div3_2">
                <div class="div3_2_2"><span class="span3_2_2"><b>综合排序</b></span>
                <a href="/Home/Sale/Sale_Shouye/<?php echo arr2link($qArr,'s');?>s/0"><span class="span3_2_1">默认排序</span></a>
                <a href="/Home/Sale/Sale_Shouye/<?php echo arr2link($qArr,'s');?>s/1"><span class="span3_2_1">时间↑ </span></a>
                <a href="/Home/Sale/Sale_Shouye/<?php echo arr2link($qArr,'s');?>s/2"><span class="span3_2_1">总价↓</span></a>
                <a href="/Home/Sale/Sale_Shouye/<?php echo arr2link($qArr,'s');?>s/3"><span class="span3_2_1">单价↓</span></a>
                <a href="/Home/Sale/Sale_Shouye/<?php echo arr2link($qArr,'s');?>s/4"><span class="span3_2_1">面积↓</span></a>
            </div>
    ...
    <div class="div4">
        <div class="div4_1">
            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><div class="div4_1_1">
                    <img src="/Uploads/<?php echo ($row["sale_house_photo_1"]); ?>"/>
                    <div class="div4_1_1_3">
                        <h3><a href="/Home/Sale/Sale_Userinfo/id/<?php echo ($row["sale_id"]); ?>"><?php echo (msubstr($row['sale_house_title'],0,23,'gbk',false)); ?></a></h3>
                        <div class="div4_1_1_2">
                            <span><a href="#"><?php echo ($row["sale_type"]); ?></a></span>
                            <span><a href="#"><?php echo ($row["sale_house_bedroom"]); echo ($row["sale_house_parlor"]); ?></a></span>
                            <span><a href="#"><?php echo ($row["sale_house_floor"]); ?>/<?php echo ($row["sale_house_total"]); ?>层</a></span>
                            <span><a href="#"><?php echo ($row["Sale_house_acreage"]); ?></a></span>
                            <span><a href="#"><?php echo ($row["sale_house_orirnt"]); ?></a></span>
                            <span><a href="#">建筑年代：<?php echo ($row["sale_more_year"]); ?></a></span>
                        </div>
                        <div  class="div4_1_1_2">
                            <span><a href="#"><?php echo ($row["sale_house_area"]); ?> </a></span>
                            <span><a href="#"><?php echo ($row["sale_house_name"]); ?></a></span>
                        </div>

                    </div>
                    <div style="float:right;width:190px;height:100px;margin-right:50px;">
                        <h4 style="font-size:24px;color:#f55353;font-family: Microsoft Yahei;"><?php echo ($row["sale_house_price"]); ?>万</h4>
                        <span style="font-size:14px;color:#999;font-family: Microsoft Yahei;">建筑面积：<?php echo ($row["sale_house_acreage"]); ?>㎡ <?php echo ($row["sale_perprice"]); echo price($row['sale_house_price'],$row['sale_house_acreage']);?>元/㎡</span>
                    </div>
