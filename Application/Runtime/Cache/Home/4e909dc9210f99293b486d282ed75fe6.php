    ...
    <div class="topNav-width clearfix">
        ...
        <div class="tnRight">
            <?php if(($_SESSION['userid']) == ""): ?><dd><h3 style="font-size: 100%;"><a href="/Home/Index/login" style="color: white">登录</a></h3></dd>
                <?php else: ?>
                <dd><h3 style="font-size: 100%;"><a href="/Home/Agent/agent_shop/id/<?php echo ($id); ?>" style="color: white"><?php echo (session('username')); ?></a></h3></dd>
       ...
       <!--自我介绍-->
        ...
        <div class="agent_house">
           ...
           <div class="agent_type">
               <a  id="agent_sell" class="agent_sell" style="color: whitesmoke;background-color:#00ae66 ">出售</a>
               <a  id="agent_rent" class="agent_rent" style="color: grey;background-color:white ">出租</a>
           </div>
            <script type="text/javascript">
                   $(function(){
//
            ...
            <!-- 店铺搜索-->
            <div id="sell_search" class="agent_shop_search">
                   <form action="/Home/Agent/agent_shop/id/<?php echo ($id); ?>" method="get">
                  ...
                  <script type="text/javascript">
                       ...
                       <div class="agent_rent_money">
                           <label>售价:</label>
                           <input type="text" name="minRent" placeholder="下限">
                           <i>--</i>
                           <input type="text" name="maxRent" placeholder="上限">
                           <b>万元</b>
                       </div>
        ...
        <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><!-- 出售房源信息-->
            <div id="sell_info" class="agent_house_rent">
                    <!-- 房源照片-->
                    <div class="agent_loupan_picture">
                        <a href="" target="_blank">
                            <img src="/Uploads/<?php echo ($row["sale_house_photo_1"]); ?>" height="140" width="180">
                        </a>
                    </div>
                    ...
                    <div class="agent_room_info">
                          <div style="font-size: 18px"><a href="/Home/Sale/Sale_Userinfo/id/<?php echo ($row["sale_id"]); ?>">[<?php echo ($row["sale_house_name"]); ?>]<?php echo (msubstr($row["sale_house_title"],0,16,'gbk')); ?></a>&nbsp;&nbsp;&nbsp;<span class="agent_label">多图</span></div>
                          <div class="agent_room_detail">
                              <p>
                                  <span><?php echo ($row["sale_type"]); ?></span>&nbsp;&nbsp;&nbsp;<span><?php echo ($row["sale_house_bedroom"]); echo ($row["sale_house_parlor"]); ?></span>&nbsp;&nbsp;&nbsp;<span><?php echo ($row["sale_house_floor"]); ?>/<?php echo ($row["sale_house_total"]); ?>层</span>&nbsp;&nbsp;&nbsp;<span><?php echo ($row["sale_house_orirnt"]); ?></span>&nbsp;&nbsp;&nbsp;<span>建筑年代：<?php echo ($row["sale_more_year"]); ?></span><br>
                                  <span><?php echo ($row["sale_house_name"]); ?></span>&nbsp;<span>[<?php echo ($row["sale_house_area"]); ?>-<?php echo ($row["sale_house_address"]); ?>]</span><br>
                                  <span>经纪人：<?php echo ($row["mid_realname"]); ?></span>&nbsp;&nbsp;&nbsp;<span><?php echo ($row["mid_company"]); ?> </span>&nbsp;&nbsp;&nbsp;<span><?php echo (date('Y-m-d H:i:s',$row["sale_date"])); ?></span>
                                  <br><br>
                              ...
                              <div class="agent_room_detail_right">
                                  <h2 style="color: red"><?php echo ($row["sale_house_price"]); ?>.00万元</h2>
                                  <h4>建筑面积：<?php echo ($row["sale_house_acreage"]); ?>㎡&nbsp;&nbsp;<?php echo (number_format($row['sale_house_price']/$row['sale_house_acreage'],2)); ?>万元/㎡</h4>
